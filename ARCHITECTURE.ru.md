...
progress удаляется либо переводится в завершённое состояние.
...
ссылки в заголовке. Быстрая карточка ограничена сеткой 2×2: приоритетная
площадка, универсальный hub, нативная отправка с кнопками и «Ещё». Внутри
«Ещё» находятся переключатели с текстовыми состояниями, добавление в подборку
и удаление с подтверждением. Цвета семантические: primary обозначает главное
