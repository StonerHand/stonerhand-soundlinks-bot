...
4. Убирает URL из пользовательского текста и превращает остаток в цитату, сохраняя абзацы, пустые строки и отступы
...
| `prepend_user_text` | Делает безопасную HTML-цитату: автор отдельной строкой, ниже текст без потери форматирования |
