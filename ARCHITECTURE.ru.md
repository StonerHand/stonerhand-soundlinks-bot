...
опубликовать в канал или добавить релиз в подборку. Редактор остаётся в одном
сообщении, запоминает предпочтения и перед внешней публикацией показывает
короткую сводку с единственной кнопкой подтверждения.
