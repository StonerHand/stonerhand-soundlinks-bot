...
ACTION_SPECS = tuple(
    ...
    for scope, code, name, kind in (
        ...
        ("editor", "retry_review", "review_delivery", ActionKind.NAVIGATION),
        ("editor", "retry_self", "retry_self", ActionKind.DELIVERY),
        ("editor", "retry_channel", "retry_channel", ActionKind.DELIVERY),
        ("editor", "sv", "save_draft", ActionKind.SETTING),
        ("editor", "reset", "reset_confirmation", ActionKind.NAVIGATION),
        ("editor", "reset_yes", "reset_original", ActionKind.SETTING),
        ("menu", "postfilter", "library_filter", ActionKind.SETTING),
        ("menu", "postsearch", "library_search", ActionKind.INPUT),
        ("menu", "postsearch_clear", "clear_library_search", ActionKind.SETTING),
        ("editor", "why_tags", "tag_sources", ActionKind.NAVIGATION),
        ...
        ("prefs", "defaults", "post_defaults", ActionKind.NAVIGATION),
        ("prefs", "collection", "collection_defaults", ActionKind.NAVIGATION),
        ...
        ("menu", "library", "library", ActionKind.NAVIGATION),
        ...
        ("editor", "ht", "tag_options", ActionKind.NAVIGATION),
        ...
        ("input", "new", "new_post", ActionKind.DELIVERY),
        ("input", "add", "add_links", ActionKind.DELIVERY),
        ("input", "back", "continue_input", ActionKind.NAVIGATION),
        ("crate", "add", "add_links", ActionKind.INPUT),
        ("crate", "replace", "replace_item", ActionKind.INPUT),
