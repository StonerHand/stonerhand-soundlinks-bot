...
from music_links_bot.bot_ui import editor_rows
    ...
    *,
    ...
    if draft_id is not None:
        ...
        if settings or show_status:
            notices.append(get_text(lang, "ed_constructor_hint"))
        if notices:
            text += "\n\n<i>" + escape("\n".join(notices)) + "</i>"
    ...
    return text, InlineKeyboardMarkup(editor_rows(draft_id, draft))
