...
Частые действия находятся прямо под постом. В «Ещё» — подборка, шаблоны
и дополнительные настройки. «Опубликовать…» открывает выбор: сейчас,
по расписанию или себе. Для обычного пользователя — «Отправить…».
Черновики и история находятся в «Моих материалах».
