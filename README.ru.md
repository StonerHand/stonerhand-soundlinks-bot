...
а успешные результаты кешируются в памяти и Redis. Если один сервис тормозит,
бот возвращает найденную часть вместо общей ошибки.
...
src/music_links_bot/    провайдеры, UI бота, доставка, очередь, Redis
