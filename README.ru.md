...
| Чистый заголовок, обложка, хэштеги и компактные кнопки | Пресеты «Минимал», «Обложка» и блочный «Лонгрид» |
...
В карточках нет рекламных подписей и скрытых ссылок в заголовке. Под обложкой
остаются только исполнитель и название; жанр, формат и год не дублируются, а
жанр используется только для полезного автохэштега. Быстрый слой
...
Бот и Студия отображают одну серверную модель публикации. На экране результата
остаётся одно главное действие, а расширенные параметры находятся в
«Оформлении». Последний пресет, хэштеги, фото-режим и порядок площадок
запоминаются для пользователя; у канала остаются собственные настройки.
...
Пользователь и канал запоминают последнее успешное оформление — «Минимал»,
«Обложка» или «Лонгрид», фото-режим, хэштеги и выбранные площадки — и применяют
его к следующему черновику
