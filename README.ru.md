...
действиями: приоритетная площадка, «Все платформы», отправка с сохранением
кнопок и компактное меню «Ещё». В нём находятся понятные переключатели
обложки, цитаты и хэштегов, а также добавление в подборку. В самой подборке
