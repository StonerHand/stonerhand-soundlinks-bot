...
- открывает `/start` как персональный рабочий стол: статус подборки, главный вход в Студию, новый пост, быстрый тур и admin-статистика без лабиринта справочных кнопок;
