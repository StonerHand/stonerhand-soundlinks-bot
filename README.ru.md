...
| Нативные Telegram Rich Messages с безопасным fallback | Блочный редактор: заголовки, текст, цитаты, списки, секции и линии |
...
Клавиатуры используют единую нативную иерархию Telegram: синяя кнопка обозначает главное действие экрана, зелёная — успешную отправку или публикацию, красная — только удаление. Площадки, навигация и служебные действия остаются нейтральными и автоматически адаптируются под тему клиента.
