...
- 🎛 **Студия** — Mini App внутри Telegram: живой предпросмотр, тумблеры, публикация в один тап
...
| `UPSTASH_REDIS_REST_URL/TOKEN` | Redis: общий кеш, живой `/stats`, вечные черновики, антидубль |
...
```bash
PYTHONPATH=src python -m pytest tests/   # 203 теста, без сети
```
