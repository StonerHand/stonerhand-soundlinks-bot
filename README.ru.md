...
- Дает трекам, альбомам, подкастам, плейлистам и YouTube-видео отдельные редакторские форматы
- Показывает тип релиза, количество найденных площадок и отдельную строку действия перед CTA
- Делает прямые кнопки для одиночного релиза
- Делает первую платформу главной кнопкой, а остальные собирает компактнее
