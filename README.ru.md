...
Универсальная кнопка Songlink/Odesli всегда идёт первой, занимает всю ширину и
получает главный цвет; прямые площадки следуют за ней как спокойные быстрые
ссылки. Эта иерархия одинакова в карточке, превью и редакторе. Нативные экраны
