...
- Держит пост чистым: заголовок, живая фраза, хэштеги, preview и кнопки
- Делает прямые кнопки для одиночного релиза
- Раскладывает платформы по две кнопки в строку, а кнопку канала оставляет отдельной строкой
