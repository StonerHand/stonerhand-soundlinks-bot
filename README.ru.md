...
### Ссылка, название или несколько релизов → готовый Telegram-пост
...
| Обложка, CTA, хэштеги и компактные кнопки площадок | CTA, цитата, теги, обложка и выбор порядка площадок |
...
Метаданные и универсальные ссылки собираются через Song.link/Odesli, iTunes Search и oEmbed. Для отправки готового поста в другой чат используй действие «Поделиться» в Студии: Telegram получит текст и кнопки площадок как одно подготовленное сообщение. Обычная пересылка Telegram сама удаляет inline-клавиатуру.
