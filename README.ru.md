...
названию релиза. Редактируемые **Черновики** и уже отправленные **Недавние**
разделены, поэтому незаконченная работа не смешивается с историей публикаций.
Помощь и редкие параметры собраны под предсказуемой кнопкой **Настройки**.
