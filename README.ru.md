...
кнопок и добавление в подборку.
...
Главное меню оставляет три действия: **открыть Студию**, **найти релиз** и
**открыть подборку**. Настройки, лонгрид, очередь и публикация находятся в
